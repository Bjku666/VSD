#!/usr/bin/env python3
"""Validate E11 P2-head model and export standard evaluation artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate YOLO11n E11 P2-head fusion model")
