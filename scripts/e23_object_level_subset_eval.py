...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--thresholds", default="/mnt/disk2/lhr/VSD/results/S0_data_protocol/dataset_audit/train_thresholds.json")
    parser.add_argument("--image-metrics", default=None)
    parser.add_argument("--imgsz", type=int, default=640)
    parser.add_argument("--batch", type=int, default=16)
    parser.add_argument("--workers", type=int, default=8)
    parser.add_argument("--device", default="0")
    parser.add_argument("--out-dir", default="/mnt/disk2/lhr/VSD/results/S6_object_background_suppression/e23_object_level_evaluator")
