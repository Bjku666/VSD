#!/usr/bin/env python3
"""Validate E12 gated fusion model and export standard evaluation artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate YOLO11n E12 residual gated fusion model")
    ...
    parser.add_argument(
        "--out-dir",
        type=str,
        default="/mnt/disk2/lhr/VSD/results/S4_head_gate_loss/e12_1_residual_gated_fusion_val",
    )
