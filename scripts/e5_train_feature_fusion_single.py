#!/usr/bin/env python3
"""Train E5 dual-backbone single-layer fusion model on DroneVehicle."""
...
# Make core module importable in DDP child workers generated by Ultralytics.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train YOLO11n E5 fusion model")
    ...
    parser.add_argument("--project", type=str, default="/mnt/disk2/lhr/VSD/experiments/e5_feature_fusion_single")
    parser.add_argument("--name", type=str, default="yolo11n_e5_rgb_ir_640")
