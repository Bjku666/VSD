...
LOG="/mnt/disk2/lhr/VSD/results/val/logs/e14_2_e6_cebs_a010_object_eval_gpu0_20260525_1231.log"
...
"$PYTHON" scripts/e23_object_level_subset_eval.py \
  --weights /mnt/disk2/lhr/VSD/results/val/e14_2_e6_cebs_a010/weights/best.pt \
  --validator e14 \
  --mode rgb_ir \
  --split val \
  --image-metrics /mnt/disk2/lhr/VSD/results/val/e14_2_e6_cebs_a010_val/required_metrics.json \
  --imgsz 640 \
  --batch 16 \
  --workers 4 \
  --device 0 \
  --out-dir /mnt/disk2/lhr/VSD/results/val/e23_e14_2_cebs_a010_object_level \
  --cebs-alpha 0.10 \
