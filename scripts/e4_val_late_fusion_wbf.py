...
def main() -> None:
    ...
    parser.add_argument(
        "--rgb-model",
        type=str,
        default="/mnt/disk2/lhr/VSD/results/S1_baselines/e1_yolo11n_rgb_only_640_ddp/weights/best.pt",
    )
    parser.add_argument(
        "--ir-model",
        type=str,
        default="/mnt/disk2/lhr/VSD/results/S1_baselines/e2_yolo11n_ir_only_640_ddp/weights/best.pt",
    )
    parser.add_argument(
        "--rgb-data",
        type=Path,
